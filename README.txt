...
pip install tkinter pandas numpy tensorflow scikit-learn rdkit joblib threading datetime matplotlib traceback PIL io subprocess sys

data.csv is in UTF-8 format